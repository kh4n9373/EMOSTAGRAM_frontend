              ...
              <div className="pricing14-price10">
                <div className="pricing14-price11">
                  <p className="pricing14-text107 thq-body-large">
                    {props.plan1 ?? (
                      <Fragment>
                        <span className="pricing14-text198">Basic plan</span>
                      </Fragment>
                    )}
                  </p>
                  ...
                  <p className="thq-body-large">
                    {props.plan1Yearly ?? (
                      <Fragment>
                        <span className="pricing14-text186">$99/year</span>
                      </Fragment>
                    )}
                  </p>
                </div>
                      ...
                      {props.plan1Feature1 ?? (
                        <Fragment>
                          <span className="pricing14-text176">
                            Access to exclusive EQ resources
                          </span>
                        </Fragment>
                      )}
                    </span>
                      ...
                      {props.plan1Feature2 ?? (
                        <Fragment>
                          <span className="pricing14-text203">
                            Join EQ workshops and discussions
                          </span>
                        </Fragment>
                      )}
                    </span>
                      ...
                      {props.plan1Feature3 ?? (
                        <Fragment>
                          <span className="pricing14-text183">
                            Connect with EQ coaches for guidance
                          </span>
                        </Fragment>
                      )}
                    </span>
              ...
              <div className="pricing14-price12">
                <div className="pricing14-price13">
                  ...
                  <p className="thq-body-large">
                    {props.plan2Yearly ?? (
                      <Fragment>
                        <span className="pricing14-text187">$199/year</span>
                      </Fragment>
                    )}
                  </p>
                </div>
              ...
              <div className="pricing14-price14">
                <div className="pricing14-price15">
                  ...
                  <h3 className="pricing14-text123 thq-heading-3">
                    {props.plan3Price ?? (
                      <Fragment>
                        <span className="pricing14-text164">$29.99/month</span>
                      </Fragment>
                    )}
                  </h3>
                  <p className="thq-body-large">
                    {props.plan3Yearly ?? (
                      <Fragment>
                        <span className="pricing14-text156">$299/year</span>
                      </Fragment>
                    )}
                  </p>
                </div>
              ...
              <div className="pricing14-price16">
                <div className="pricing14-price17">
                  ...
                  <h3 className="pricing14-text132 thq-heading-3">
                    {props.plan1Price1 ?? (
                      <Fragment>
                        <span className="pricing14-text178">$200/yr</span>
                      </Fragment>
                    )}
                  </h3>
              ...
              <div className="pricing14-price18">
                <div className="pricing14-price19">
                  ...
                  <h3 className="pricing14-text139 thq-heading-3">
                    {props.plan2Price1 ?? (
                      <Fragment>
                        <span className="pricing14-text182">$299/yr</span>
                      </Fragment>
                    )}
                  </h3>
                  <span className="thq-body-large">
